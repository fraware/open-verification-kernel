...
DOMAIN_CONFIG: dict[str, dict[str, Any]] = {
    "authorization": {
        ...
        "failure_modes": ["middleware_skipped", "route_group_unprotected", "policy_default_allow", "role_check_removed"],
        "evidence": [
...
CURATED_TEMPLATES: list[dict[str, Any]] = [
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "critical", "likelihood": "medium", "rationale": "Memory safety regressions in auth paths are exploitable."},
    ...
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "critical", "likelihood": "medium", "rationale": "IAM regressions expose cloud control planes."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "high", "likelihood": "medium", "rationale": "Topology regressions enable data exfiltration."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "high", "likelihood": "medium", "rationale": "Skipped approvals enable unreviewed production changes."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "critical", "likelihood": "low", "rationale": "Memory corruption can leak cross-tenant data."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "failure_modes": ["self_approval", "gate_removal", "bot_bypass"],
            "acceptable_evidence": [{"kind": "policy_check", "minimum_confidence": "high"}],
            "risk": {"severity": "critical", "likelihood": "high", "rationale": "Agents must not weaken their own verification gates."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "critical", "likelihood": "medium", "rationale": "Secret exposure in CI is a common agent regression."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "acceptable_evidence": [{"kind": "policy_check", "minimum_confidence": "high"}],
            "risk": {"severity": "high", "likelihood": "medium", "rationale": "Cross-account leaks expand blast radius."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    ...
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "high", "likelihood": "low", "rationale": "Unsafe rollbacks can reintroduce known failures."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    ...
    },
    {
        ...
        "payload": {
            ...
            "acceptable_evidence": [{"kind": "proof", "minimum_confidence": "high"}],
            "risk": {"severity": "critical", "likelihood": "medium", "rationale": "Authority escalation enables autonomous harm."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "risk": {"severity": "high", "likelihood": "medium", "rationale": "Weakened build gates enable supply-chain regressions."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "acceptable_evidence": [{"kind": "policy_check", "minimum_confidence": "high"}],
            "risk": {"severity": "critical", "likelihood": "medium", "rationale": "Privilege escalation is a primary auth regression class."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
    {
        ...
        "payload": {
            ...
            "failure_modes": ["public_exposure", "lateral_movement_path"],
            "acceptable_evidence": [{"kind": "topology_model", "minimum_confidence": "medium"}],
            "risk": {"severity": "high", "likelihood": "medium", "rationale": "Public egress from sensitive tiers enables exfiltration."},
            "merge_policy": {"on_pass": "allow", "on_fail": "block", "on_unknown": "require_human_review"},
            "provenance": {"source": "ovk-template-library", "canonical": True},
        },
    },
